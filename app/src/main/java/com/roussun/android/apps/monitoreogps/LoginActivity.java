...
public class LoginActivity extends AppCompatActivity {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            mAuthTask.execute(MyApplication.URL_AUTHENTICATE_DATA);
        }
    }
    ...
    public class UserLoginTask extends AsyncTask<String, Void, User> {
        ...
        protected User doInBackground(String... params) {
            ...
            Log.e("respuesta", "params[0]: " + params[0]);
            Log.e("respuesta", "gson.toJson(user): " + gson.toJson(user));
            try {
                String _respuesta = restFulWebService.postDataJson(params[0], gson.toJson(user));
                Log.e("respuesta", "_respuesta: " + _respuesta);
                if (!_respuesta.equals("") && !_respuesta.equals(null)) {
                    try {
                        JSONObject obj = new JSONObject(_respuesta);
                        userResponse = gson.fromJson(obj.getString("user"), User.class);
                        Log.e("respuesta", "gson.toJson(userResponse): " + userResponse);
        ...
        protected void onPostExecute(final User user) {
            ...
            if (user != null) {
                Log.e("respuesta", "user: " + user.getName());
                finish();
